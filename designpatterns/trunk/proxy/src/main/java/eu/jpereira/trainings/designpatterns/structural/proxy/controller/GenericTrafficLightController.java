 ...
 * 
 */
public class GenericTrafficLightController extends TrafficLightController {

	/**
	 * @param ipAddress
	 */
	public GenericTrafficLightController(String ipAddress) {
		super(ipAddress);
	}
	...
	public void sendPowerCommand(ControllerCommand command) throws CouldNotConnectException {
		System.out.println("Power Command recived: " + command);
	}
	...
	public void sendLightCommand(ControllerCommand command) throws CouldNotConnectException {
		System.out.println("Light Command received: " + command);
