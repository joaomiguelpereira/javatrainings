...
import eu.jpereira.trainings.designpatterns.structural.proxy.controller.ProxyTrafficLightController;
 ...
 *
 */
public class FakedProxyTrafficLightControler extends ProxyTrafficLightController{

	/**
	 * @param ipAddress
	 */
	public FakedProxyTrafficLightControler(String ipAddress) {
		super(ipAddress);
	}
