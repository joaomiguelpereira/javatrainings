...
import eu.jpereira.trainings.designpatterns.structural.proxy.fakes.FakeResilientTrafficLightDataSource;
...
public class ResilientTrafficLightsManagerTest extends TrafficLightsManagerTest {
	...
	protected TrafficLightsManager createTrafficLightsManager() {
		TrafficLightsManager manager = new TrafficLightsManager(new FakeResilientTrafficLightDataSource());
		return manager;
	}
}
