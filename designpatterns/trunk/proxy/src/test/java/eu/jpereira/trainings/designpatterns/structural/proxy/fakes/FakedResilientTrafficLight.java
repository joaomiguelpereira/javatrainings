...
public class FakedResilientTrafficLight extends FakeTrafficLight {

	/**
	 * @param ipAddress
	 */
	public FakedResilientTrafficLight(String ipAddress) {
		super(ipAddress);
	}
	...
	protected TrafficLightController createDefaultTrafficLightController() {
		...
		if (TestConfiguration.fakeFailuresInController ) {
			realController = new FakedResilientTrafficLightController(this.getIpAddress());
		} else {
