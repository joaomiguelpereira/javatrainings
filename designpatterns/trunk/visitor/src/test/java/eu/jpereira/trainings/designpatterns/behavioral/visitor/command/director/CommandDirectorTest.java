 ...
 */
package eu.jpereira.trainings.designpatterns.behavioral.visitor.command.director;
...
import eu.jpereira.trainings.designpatterns.behavioral.visito.appliance.ApplianceCommunicationException;
import eu.jpereira.trainings.designpatterns.behavioral.visitor.command.Command;
import eu.jpereira.trainings.designpatterns.behavioral.visitor.command.Event;
import eu.jpereira.trainings.designpatterns.behavioral.visitor.command.StartApplianceCommand;
import eu.jpereira.trainings.designpatterns.behavioral.visitor.command.TurnOnApplianceCommand;
import eu.jpereira.trainings.designpatterns.behavioral.visitor.command.director.CommandDirector;
import eu.jpereira.trainings.designpatterns.behavioral.visitor.command.director.DefaulCommandDirector;
import eu.jpereira.trainings.designpatterns.behavioral.visitor.command.director.ErrorDirectingCommandsException;
