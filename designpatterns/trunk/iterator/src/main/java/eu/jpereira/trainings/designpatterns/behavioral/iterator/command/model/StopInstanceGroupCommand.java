 ...
 * 
 */
public class StopInstanceGroupCommand extends DBServerInstanceGroupCommand {
	/**
	 * Create a new instance of {@link StartInstanceGroupCommand}
	 * 
	 * @param receiver
	 *            the instance of {@link DBServerInstanceGroup} that will handle
	 *            the request
	 */

	public StopInstanceGroupCommand(DBServerInstanceGroup receiver) {
		super(receiver);
	 ...
	 * .DBServerInstanceGroupCommand#execute()
	 */	
	@Override
	public void execute() throws CouldNotConnectException {
		this.receiver.stopAllInstances();
