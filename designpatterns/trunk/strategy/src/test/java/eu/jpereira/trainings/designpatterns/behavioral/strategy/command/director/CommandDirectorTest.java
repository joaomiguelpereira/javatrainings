...
import eu.jpereira.trainings.designpatterns.behavioral.strategy.command.Event;
import eu.jpereira.trainings.designpatterns.behavioral.strategy.command.StartApplianceCommand;
import eu.jpereira.trainings.designpatterns.behavioral.strategy.command.TurnOnApplianceCommand;
import eu.jpereira.trainings.designpatterns.behavioral.strategy.command.director.CommandDirector;
import eu.jpereira.trainings.designpatterns.behavioral.strategy.command.director.DefaulCommandDirector;
import eu.jpereira.trainings.designpatterns.behavioral.strategy.command.director.ErrorDirectingCommandsException;
