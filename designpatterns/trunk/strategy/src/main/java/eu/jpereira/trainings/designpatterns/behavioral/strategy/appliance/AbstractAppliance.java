 ...
 */
package eu.jpereira.trainings.designpatterns.behavioral.strategy.appliance;
...
import eu.jpereira.trainings.designpatterns.behavioral.strategy.appliance.state.ApplianceStateBehavior;
...
public abstract class AbstractAppliance implements Appliance {
	...
	protected CommunicationStrategy strategy = null;
	...
	public AbstractAppliance(ApplianceState initialState, CommunicationStrategy strategy) {
		this.applianceStateBehavior = initialState.getStateBehavior(strategy);
