...
public class SimpleVehicleBuilderTest {
	...
	@Test
	public void testTimesOne() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CouldNotCloneLastObjectException, CannotHaveZeroParts {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
		Vehicle vehicle = builder.createVehicle().with(new Tire()).times(1).packIt();
		assertEquals(1, vehicle.countParts());
		
	}
	@Test(expected=CannotHaveZeroParts.class)
	public void testTimesZero() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CouldNotCloneLastObjectException, CannotHaveZeroParts {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
		builder.createVehicle().with(new Tire()).times(0).packIt();
	}
	
	@Test
	public void testTimesMany() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CouldNotCloneLastObjectException, CannotHaveZeroParts {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
	...
	@Test
	public void testTimesManyDifferent() throws NeedToPackLastVehicleException, VehicleDoesNotHavePartsException, CouldNotCloneLastObjectException, CannotHaveZeroParts {
		SimpleVehicleBuilder builder = new SimpleVehicleBuilder();
