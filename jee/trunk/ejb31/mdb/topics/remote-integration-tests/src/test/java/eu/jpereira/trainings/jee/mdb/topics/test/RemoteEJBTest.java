package eu.jpereira.trainings.jee.mdb.topics.test;
...
public abstract class RemoteEJBTest {
	 ...
	 */
	protected static <T> T getStatelessSessionBeanReferenceFor(Class<?> viewClass,
	...
	protected static <T> T getSatefulSessionBeanReferenceFor(Class<?> viewClass,
			Class<?> beanClass) throws NamingException {
		return getSessionBeanReferenceFor(viewClass, beanClass, true);
	}

	@SuppressWarnings("unchecked")
	private static <T> T getSessionBeanReferenceFor(Class<?> viewClass,
