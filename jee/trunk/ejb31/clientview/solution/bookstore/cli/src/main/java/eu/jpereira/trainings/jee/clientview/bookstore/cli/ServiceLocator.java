...
public class ServiceLocator {
	...
	private static BookstoreService lookupBookstoreService()
		...
		final String appName = "ear-1.0-FINAL";
		...
		// the ejb-jar.xml
		final String moduleName = "ejb-1.0-FINAL";
		...
		final String beanName = BookstoreServiceBean.class.getSimpleName();
		// the remote view fully qualified class name
		final String viewClassName = BookstoreService.class.getName();
