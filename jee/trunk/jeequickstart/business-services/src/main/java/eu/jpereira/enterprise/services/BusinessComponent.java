...
/**
 * Generic Business Component Contract
 * @author jpereira
 *
 */
@Local
public interface BusinessComponent {
	...
	public void removeBusinessEntity(Long zoneId);
	public void updateBusinessEntity(Long entityId, BusinessEntity businessEntity);
